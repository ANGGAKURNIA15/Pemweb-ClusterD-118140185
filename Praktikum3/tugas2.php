...
<body>
	...
	<form action="" method="get">
		...
		<input type="text" id="warna" name="warna" placeholder="Biru, Kuning, dan Hijau">
		<br><br>
		...
		function tampil($nama,$warna){
			...
			if ($countname<=10 && $countname>=1 ) {
				...
				if ($warna=="biru" || $warna=="Biru") {
					...
					echo "Maaf, pilihan warna yang tersedia hanya Biru, Kuning, dan Hijau";
				}
